    ...
    return (
        <div id='contact' className='bg-slate-900 w-full hs-screen flex flex-col justify-between justify-center pt-16'>
                ...
                <div className='flex flex-row justify-center justify-between items-center h-[60vh]'>
                    <div>
                        <img ref={parallaxX.ref} alt='notebook' className='invisible lg:visible w-40 h-40 pl-8' src={pic5}></img>
                    </div>
                    ...
                    <div>
                        <img ref={parallaxY.ref} alt='pen' className='invisible lg:visible w-40 h-40 pr-8' src={pic4}></img>
                    </div>
                </div>
        </div>
    )
